...
const Collab = () => {
  ...
  return (
    <Section crosses>
      <div className="relative max-w-[1280px] md:px-10 mx-auto">
        <div className="flex">
          ...
          <div className=" absolute max-md:px-4 ml-4 md:ml-12">
            <div className="relative md:top-20 mb-[24px] pt-0">
              <a
                ...
                <div className="flex items-center p-3 px-5">
                  ...
                  <div className="md:pr-5 pr-3 md:mr-2 md:pl-2">
                    <div className="font-medium text-white text-[16px] max-md:text-[14px] leading-5">
                      Introducing SafeCyber Copilot X
                    </div>
                    <div className="text-neutral-500 max-md:text-[14px] text-[16px]">
                      Your Ai pair protector is leveling Up
                    </div>
                  </div>
            ...
            <h1 className="md:mt-24 lg:mt-28 sm:mt-10 relative z-2 max-md:mb-5 text-[48px] md:text-[72px] max-sm:leading-[60px] max-md:leading-[80px] lg:text-[80px] font-semibold text-white mb-20">
              {" "}
            ...
            <p className="relative z-1 text-[24px] md:text-[28px]  lg:text-[32px] leading-[30px] md:leading-[36px] lg:leading-[44px] mb-5 md:mb-12 md:10/12  lg:w-9/12 text-[#7d8590]">
              Discover the platform developers adore: where productivity meets
              collaboration and security is celebrated. Unlock a world of
              efficiency, innovation, and peace of mind. Welcome to your
              development haven.
            </p>
