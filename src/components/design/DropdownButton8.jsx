...
import Quiz8 from "./Quiz8"; // Import the Quiz3 component

const DropdownButton8 = () => {
  ...
  return (
    <div className="relative">
      ...
      {showQuiz && <Quiz8 exitQuiz={exitQuiz} />} {/* Render Quiz3 component */}
    </div>
  );
};

export default DropdownButton8;
