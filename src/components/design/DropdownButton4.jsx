...
import Quiz4 from "./Quiz4"; // Import the Quiz3 component

const DropdownButton4 = () => {
  ...
  return (
    <div className="relative">
      ...
      {showQuiz && <Quiz4 exitQuiz={exitQuiz} />} {/* Render Quiz3 component */}
    </div>
  );
};

export default DropdownButton4;
