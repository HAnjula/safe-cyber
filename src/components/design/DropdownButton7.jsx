...
import Quiz7 from "./Quiz7"; // Import the Quiz3 component

const DropdownButton7 = () => {
  ...
  return (
    <div className="relative">
      ...
      {showQuiz && <Quiz7 exitQuiz={exitQuiz} />} {/* Render Quiz3 component */}
    </div>
  );
};

export default DropdownButton7;
