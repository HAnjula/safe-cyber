...
import Quiz5 from "./Quiz5"; // Import the Quiz3 component

const DropdownButton5 = () => {
  ...
  return (
    <div className="relative">
      ...
      {showQuiz && <Quiz5 exitQuiz={exitQuiz} />} {/* Render Quiz3 component */}
    </div>
  );
};

export default DropdownButton5;
